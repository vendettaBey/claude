    ...
    <Section id="neden-biz" labelledBy="neden-biz-baslik" className="bg-ink-900/30">
      <div className="container-page">
        <SectionHeading
          ...
          align="left"
          segments={[
            { text: 'Hazır paket değil,' },
            { text: 'size göre çalışan sistem', highlight: true },
          ]}
          description="İhtiyacı netleştirir, kapsamı görünür tutar ve yayından sonra desteği sürdürürüz."
        />
          ...
          {valueProps.map((item, index) => (
            ...
            >
              <SpotlightCard accent={item.accent} tilt className="h-full p-6">
                <span
                  className="feature-icon-surface grid size-11 place-items-center rounded-xl border border-white/10"
                  style={{
                ...
                <h3 className="font-display text-fg mt-5 text-base font-semibold sm:text-lg">
                  {item.title}
                </h3>
